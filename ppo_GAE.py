...
def run_ppo_with_net(seed=0):
    ...
    while total_steps < max_steps:
        ...
        ratio = torch.exp(log_probs - torch.stack(log_probs_old))
...
if __name__ == "__main__":
    ...
    df_eval.to_csv('./results/ppo_GAE_score.csv', index=False)
    ...
    df.to_csv('./results/ppo_GAE_results.csv', index=False)
