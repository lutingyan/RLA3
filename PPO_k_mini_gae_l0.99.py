...
def run_ppo_with_net(seed=0):
    ...
    while total_steps < max_steps:
        ...
        advantages, returns = compute_advantages_and_returns(rewards, values, dones, gamma, lam)
...
if __name__ == "__main__":
    ...
    df_eval.to_csv('./results/l0.99_score.csv', index=False)
    ...
    df.to_csv('./results/l0.99_results.csv', index=False)
