    ...
    while total_steps < max_steps:
        ...
        for _ in range(K_epoch):
            ...
            for start in range(0, dataset_size, minibatch_size):
                ...
                if kl_div > 1.5 * kl_target:
                    beta *= 2
                elif kl_div < 0.5 * kl_target:
                    beta *= 0.5
...
if __name__ == "__main__":
    ...
    df_eval.to_csv('./results/ppo_klminigae_adp_score.csv', index=False)
    ...
    df.to_csv('./results/ppo_klminigae_adp_results.csv', index=False)
