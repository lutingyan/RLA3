# Soft Actor-Critic (SAC) for CartPole (discrete action version) without entropy bonus
    ...
    while total_steps < max_steps:
        ...
        while not done:
            ...
            if len(replay_buffer) > batch_size:
                ...
                actor_loss = (probs * (-min_q)).sum(dim=1).mean()
...
if __name__ == "__main__":
    ...
    df_eval.to_csv('./results/sac_nolog_score.csv', index=False)
    ...
    df_train.to_csv('./results/sac_nolog_results.csv', index=False)
